...
[![Go Report Card](https://goreportcard.com/badge/github.com/ImPedro29/go-ethereum-hdwallet?)](https://goreportcard.com/report/github.com/ImPedro29/go-ethereum-hdwallet)
[![GoDoc](https://godoc.org/github.com/ImPedro29/go-ethereum-hdwallet?status.svg)](https://godoc.org/github.com/ImPedro29/go-ethereum-hdwallet)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](#contributing)

## Install

```bash
go get -u github.com/ImPedro29/go-ethereum-hdwallet
```

## Documenation

[https://godoc.org/github.com/ImPedro29/go-ethereum-hdwallet](https://godoc.org/github.com/ImPedro29/go-ethereum-hdwallet)
...
import (
	...
	"github.com/ImPedro29/go-ethereum-hdwallet"
)
...
```bash
go install github.com/ImPedro29/go-ethereum-hdwallet/cmd/geth-hdwallet@latest
```
